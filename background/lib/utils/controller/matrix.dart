...
class MatrixGestureDetector extends StatefulWidget {
  ...
  const MatrixGestureDetector({
    ...
    this.behavior = HitTestBehavior.deferToChild, required this.onScaling,
  })  : super(key: key);
...
class _MatrixGestureDetectorState extends State<MatrixGestureDetector> {
  ...
  void onScaleUpdate(ScaleUpdateDetails details) {
    ...
    localOffset = details.focalPoint;
  ...
  void onScaleUpEnd(ScaleEndDetails details) {
